...
class Tree(wx.TreeCtrl):
    def __init__(self,parent,style):
        ...
        LEMITLESS_TREE=image_list.Add(wx.Image("Resources/dd.png", wx.BITMAP_TYPE_PNG).Scale(16, 16).ConvertToBitmap())
        Java = image_list.Add(wx.Image("Resources/java.png", wx.BITMAP_TYPE_PNG).Scale(16, 16).ConvertToBitmap())
        C = image_list.Add(wx.Image("Resources/c.png", wx.BITMAP_TYPE_PNG).Scale(16, 16).ConvertToBitmap())
        CPP= image_list.Add(wx.Image("Resources/cpp.png", wx.BITMAP_TYPE_PNG).Scale(16, 16).ConvertToBitmap())
        ...
        Conditional = self.AppendItem(java, text='Conditional and Return Statements', data='')
        ...
        self.AppendItem(ParsingFunctions, text='Integer.parseInt()', data='Integer.parseInt()')
        self.AppendItem(ParsingFunctions, text='Float.parseFloat()', data='Float.parseFloat()')
        self.AppendItem(ParsingFunctions, text='Double.parseDouble()', data='Double.parseDouble()')
        self.AppendItem(ParsingFunctions, text='Byte.praseByte()', data='Byte.praseByte()')
        ...
        self.AppendItem(AWTFunctions, text='getSelectedCheckBox()', data='getSelectedCheckBox()')
        self.AppendItem(AWTFunctions, text='setSelectedCheckBox()', data='setSelectedCheckBox()')
        self.AppendItem(AWTFunctions, text='add()', data='add()')
        self.AppendItem(AWTFunctions, text='getSelectedItem()', data='getSelectedItem()')
        self.AppendItem(AWTFunctions, text='getSelectedItems()', data='getSelectedItems()')
        ...
        self.AppendItem(AWTFunctions, text='getSelectedText()', data='getSelectedText()')
        ...
        AppletFunctions = self.AppendItem(Functions, text='Applet Life Cycle Methods', data='')
        ...
        self.AppendItem(OtherFunctions, text='main()', data='public static void main(String ar[])\n{\n  \n}')
        self.AppendItem(AppletFunctions, text='finalize()', data='finalize()')

        AWTandSwingComponents = self.AppendItem(java, text='AWT and Swing Components', data='')
        self.AppendItem(AWTandSwingComponents, text='Label()', data='Label l = new Label("");\n')
        self.AppendItem(AWTandSwingComponents, text='Button()', data='Button b = new Button("");\n')
        self.AppendItem(AWTandSwingComponents, text='Choice()', data='Choice c = new Choice();\n')
        self.AppendItem(AWTandSwingComponents, text='TextField()', data='TextField t = new TextField("");\n')
        self.AppendItem(AWTandSwingComponents, text='TextArea()', data='TextArea ta = new TextArea();\n')
        self.AppendItem(AWTandSwingComponents, text='Checkbox()', data='Checkbox c = new Checkbox();\n')
        self.AppendItem(AWTandSwingComponents, text='CheckBoxGroup()', data='Checkbox c = new Checkbox(String label, boolean state, CheckboxGroup cbg);\n')
        self.AppendItem(AWTandSwingComponents, text='List()', data='List s = new List();\n')
        self.AppendItem(AWTandSwingComponents, text='MenuBar()', data='MenuBar mb = new MenuBar();\n')
        self.AppendItem(AWTandSwingComponents, text='Menu()', data='Menu m = new Menu("");\n')
        self.AppendItem(AWTandSwingComponents, text='MenuItem()', data='MenuItem mi = new MenuItem("");\n')
        self.AppendItem(AWTandSwingComponents, text='JLabel()', data='JLabel l = new JLabel("");\n')
        self.AppendItem(AWTandSwingComponents, text='JButton()', data='JButton b = new JButton("");\n')
        self.AppendItem(AWTandSwingComponents, text='JTextField()', data='JTextField t = new JTextField("");\n')
        self.AppendItem(AWTandSwingComponents, text='JTextArea()', data='JTextArea t = new JTextArea("");\n')
        self.AppendItem(AWTandSwingComponents, text='JComboBox()', data='JComboBox C = new JComboBox();\n')
        self.AppendItem(AWTandSwingComponents, text='JCheckBox()', data='JCheckBox c = new JCheckBox("1");\n')
        self.AppendItem(AWTandSwingComponents, text='JRadioButton()', data='JRadioButton r = new JRadioButton("1");\n')
        self.AppendItem(AWTandSwingComponents, text='JTree()', data='JTree jt=new JTree(DefaultMutableTreeNodeObjectName);\n')
        self.AppendItem(AWTandSwingComponents, text='JPasswordField()', data='JPasswordField p = new JPasswordField();\n')
        self.AppendItem(AWTandSwingComponents, text='JMenuBar()', data='JMenuBar mb = new JMenuBar();\n')
        self.AppendItem(AWTandSwingComponents, text='JMenu()', data='JMenu m = new JMenu("");\n')
        self.AppendItem(AWTandSwingComponents, text='JMenuItem()', data='JMenuItem mi = new JMenuItem("");\n')
